...
const TopCabinets = () => {
  ...
  // Fetch cabinet types for top cabinets (wall category)
  const { data: cabinetTypes } = useQuery({
    queryKey: ['cabinet-types-wall'],
    queryFn: async () => {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              Top <span className="text-transparent bg-clip-text bg-gradient-primary">Cabinets</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Wall-mounted cabinets for your kitchen. View pricing below and use "Create Your Cabinet" to customize and order.
            </p>
            ...
            {(!cabinetTypes || cabinetTypes.length === 0) && (
              <div className="text-center py-12">
                <p className="text-muted-foreground">
                  No top cabinet types configured. Please set up cabinet types in the admin panel.
                </p>
              </div>
            )}
          </div>
