...
const PanelsFillers = () => {
  ...
  // Fetch cabinet types for panels/fillers (panels category)
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              Dress Panels & <span className="text-transparent bg-clip-text bg-gradient-primary">Fillers</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Finishing touches for your kitchen. View pricing below and use "Create Your Cabinet" to customize and order.
            </p>
            ...
            <div className="bg-muted/30 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-muted-foreground mt-2">Perfect for finishing your kitchen</p>
              </div>
            </div>
            ...
            {(!cabinetTypes || cabinetTypes.length === 0) && (
              <div className="text-center py-12">
                <p className="text-muted-foreground">
                  No panel/filler types configured. Please set up cabinet types in the admin panel.
                </p>
              </div>
            )}
          </div>
