...
const PantryCabinets = () => {
  ...
  // Fetch pantry cabinets (tall category)
          ...
          {cabinetTypes.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                {selectedFilter === 'all' 
                  ? 'No pantry cabinets are currently available.' 
                  : `No pantry cabinets found in the "${getFilterLabel(selectedFilter)}" category.`
                }
              </p>
              {selectedFilter !== 'all' && (
                <Button 
