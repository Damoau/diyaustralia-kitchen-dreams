...
const Pantry = () => {
      ...
      for (const cabinetType of cabinetTypes) {
        ...
        if (typeFinishes.length > 0) {
          const ranges = typeRanges.length > 0 ? typeRanges : [
            { id: 'default-1', label: '600 - 700mm', min_width_mm: 600, max_width_mm: 700 },
            { id: 'default-2', label: '700 - 800mm', min_width_mm: 700, max_width_mm: 800 },
            { id: 'default-3', label: '800 - 900mm', min_width_mm: 800, max_width_mm: 900 }
          ];

          const hardwareCost = 75; // Higher hardware cost for pantry
            ...
            sizes: ranges.map((range: any) => {
              ...
              const prices = typeFinishes.map((finish: any) => {
                if (!finish.door_style || !finish.door_style_finish) {
                  ...
                  return 200; // Default price for pantry
                }
  ...
  const parseWidthRange = (rangeStr: string): number => {
    ...
    return match ? parseInt(match[0]) : 600;
  };
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              Pantry <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-600">Cabinets</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Spacious pantry storage solutions. Click any price to configure and add to your quote.
            </p>
            ...
            <div className="bg-muted/30 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">(full height pantry)</p>
                  <p className="text-primary font-medium mt-1">25% extra for custom height up to 2400mm</p>
                </div>
                <div className="text-left">
          ...
          {(!cabinetTypes || cabinetTypes.length === 0) && (
            <div className="text-center py-12">
              <p className="text-muted-foreground">
                No pantry cabinet types configured yet. Please set up cabinet types in the admin panel.
              </p>
            </div>
          )}
        </div>
