...
const BaseCabinets = () => {
  ...
  // Get dynamic pricing for all cabinet types
  const cabinetPricingData = (cabinetTypes || []).map(cabinetType => {
        ...
        <div className="container mx-auto px-4">
          ...
          {loadingCabinets ? (
            ...
            <div className="space-y-12">
              {cabinetPricingData.map(({ cabinetType, priceTableData, isLoading }) => (
                  ...
                  <CardContent>
                    {!priceTableData ? (
                      ...
                      <>
                        ...
                        {priceTableData.finishes && priceTableData.finishes.length > 0 && (
                          <div className="mb-8">
                            <h3 className="text-lg font-semibold mb-4">Available Styles</h3>
                            <Carousel className="w-full max-w-4xl mx-auto">
                              <CarouselContent>
                                {priceTableData.finishes.map((finish: any) => (
                        ...
                        <div className="overflow-x-auto">
                          <table className="w-full border-collapse border border-border">
                            ...
                            <tbody>
                              {priceTableData.sizes?.map((size: any, sizeIndex: number) => (
