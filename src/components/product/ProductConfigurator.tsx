...
export const ProductConfigurator: React.FC<ProductConfiguratorProps> = ({
  ...
  useEffect(() => {
    ...
    if (postcodeData) {
      ...
      setAssemblyEstimate({
        ...
        lead_time_days: isEligible ? 8 : undefined,
        includes: isEligible ? [
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-7xl max-h-[90vh] overflow-hidden p-0 mobile-modal-high-z bg-background border shadow-2xl">
                                ...
                                <div className="p-3 rounded-lg border border-primary bg-primary/5 ring-1 ring-primary/20">
                                 ...
                                 <div className="space-y-2">
                                   ...
                                   >
                                    ...
                                    {/* Only show assembly options if assembly is available */}
                                    {assemblyEstimate?.eligible === true && (
                                      <>
